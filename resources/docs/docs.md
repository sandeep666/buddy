...
The `home-routes` handler in the `myapp.routes.home` namespace
...
The `home-page` function will in turn call the `myapp.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/myapp/core.cljs` file.
